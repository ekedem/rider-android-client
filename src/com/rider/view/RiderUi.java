...
//		alert.show();
	...
	public void showTutorial(){
		if (setCurrentScreenView(R.layout.tutorial)) {
			TextView tutorialText = (TextView) viewOwner.findViewById(R.id.tutorialText);
			tutorialText.setText(Html.fromHtml(
					"<u><b>קו</b></u>  " +
					"<br />" +
					"מציג את מסלול הקו על גבי המפה. בחלון שיפתח בחרו בקו המבוקש ולחצו על אישור" +
					"<br />" +
					"<br />" +
					"<u>ניווט</u>  " +
					"<br />" +
					"מציג מסלול מותאם אישית מנקודה לנקודה. בחלון שיפתח הכניסו כתובת מוצא (מקומכם הנוכחי נלקח כברירת המחדל) ויעד, ולחצו על אישור" +
					"<br />" +
					"<br />" +
					"<u>צ'ק אין</u>  " +
					"<br />" +
					"מדווח למערכת באיזה קו אתם נוסעים. בחלון שיפתח בחרו בקו בו אתם נוסעים ולחצו אישור. פונק' זו חשובה מאוד שכן היא מאפשרת לכם לעזור לנו לשפר את המערכת" +
					"<br />" +
					"<br />" +
					"<u>הראה אותי</u>  " +
					"<br />" +
					"מציג את מקומכם וממרכז את המפה סביבכם" +
					"<br />" +
					"<br />" +
					"<u>עדכן את קווי האוטובוס</u>  " +
					"<br />" +
					"מרענן את רשימת קווי האוטובוס" +
					"<br />" +
					"<br />" +
					"<u>הצג את כל התחנות</u>  " +
					"<br />" +
					"כאשר מסומן כל תחנות הקו יוצגו וכאשר לא מסומן תוצג רק התחנה הקרובה ביותר"));
		}
	}
